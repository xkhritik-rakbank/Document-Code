			...
			if(mainCodeValueC.equals("0") && totalcocolRecord>0)
			{
				...
				for(objWorkList.reInitialize(true);objWorkList.hasMoreElements(true);objWorkList.skip(true))
				{
					...
					{		
						...
						individualCoColCellValueMap.put(CoColGridColumn[j],objWFCustomXmlResponse.getVal(Cocol_Limit_ColName));	
					}
					completeCoColDataArrList.add(individualCoColCellValueMap);
					logger.info("check individualCoColCellValueMap" +individualCoColCellValueMap);
